...
public static class ControlCatalog
{
    private static readonly List<ControlDefinition> _controls = new()
    {
        ...
        // ══════════════════════════════════════════════════════════════
        // EXTENDED CHECK: Cryptography & TLS Hardening (Phase 12.8)
        // Enforces TLS 1.2+ and disables weak protocols (SSL 2.0/3.0, TLS 1.0/1.1)
        // ══════════════════════════════════════════════════════════════
        new ControlDefinition
        {
            ControlId = "EXT-11", BaselineId = "", Title = "Cryptography & TLS Hardening",
            Description = "Enforces strong cryptography: .NET SchUseStrongCrypto, TLS 1.2/1.3 enablement, and disabling of weak protocols (SSL 2.0/3.0, TLS 1.0/1.1).",
            Category = CheckCategory.System, Severity = CheckSeverity.High, IsBaseline = false,
            TechnicalCheckIds = new() { "CRP-001" },
            SubControls = new()
            {
                new SubControlDefinition { SubControlId = "CRP-001.1", SettingName = ".NET 4.x Strong Crypto (64-bit)", ExpectedValue = "1", Description = "SchUseStrongCrypto = 1 forces .NET 4.x apps to use TLS 1.2+ and strong ciphers.", Category = CheckCategory.System, Severity = CheckSeverity.High, IsRequired = true, ParentControlId = "EXT-11", EvidenceSources = new() { "Registry HKLM\\SOFTWARE\\Microsoft\\.NETFramework\\v4.0.30319" }, ExpectedValueType = ExpectedValueType.Integer, Operator = Operator.Equals },
                new SubControlDefinition { SubControlId = "CRP-001.2", SettingName = ".NET 4.x Strong Crypto (32-bit WOW64)", ExpectedValue = "1", Description = "Same setting for 32-bit apps running on 64-bit Windows.", Category = CheckCategory.System, Severity = CheckSeverity.High, IsRequired = true, ParentControlId = "EXT-11", EvidenceSources = new() { "Registry HKLM\\SOFTWARE\\WOW6432Node\\Microsoft\\.NETFramework\\v4.0.30319" }, ExpectedValueType = ExpectedValueType.Integer, Operator = Operator.Equals },
                new SubControlDefinition { SubControlId = "CRP-001.3", SettingName = "TLS 1.2 Client Enabled", ExpectedValue = "1", Description = "Enables TLS 1.2 for outbound connections (SCHANNEL).", Category = CheckCategory.Network, Severity = CheckSeverity.High, IsRequired = true, ParentControlId = "EXT-11", EvidenceSources = new() { "Registry HKLM\\SYSTEM\\CurrentControlSet\\Control\\SecurityProviders\\SCHANNEL\\Protocols\\TLS 1.2\\Client" }, ExpectedValueType = ExpectedValueType.Integer, Operator = Operator.Equals },
                new SubControlDefinition { SubControlId = "CRP-001.4", SettingName = "TLS 1.2 Server Enabled", ExpectedValue = "1", Description = "Enables TLS 1.2 for inbound connections (SCHANNEL).", Category = CheckCategory.Network, Severity = CheckSeverity.High, IsRequired = true, ParentControlId = "EXT-11", EvidenceSources = new() { "Registry HKLM\\SYSTEM\\CurrentControlSet\\Control\\SecurityProviders\\SCHANNEL\\Protocols\\TLS 1.2\\Server" }, ExpectedValueType = ExpectedValueType.Integer, Operator = Operator.Equals },
                new SubControlDefinition { SubControlId = "CRP-001.5", SettingName = "SSL 2.0 Client Disabled", ExpectedValue = "0", Description = "Disables obsolete and vulnerable SSL 2.0 protocol (prevents DROWN attack).", Category = CheckCategory.Network, Severity = CheckSeverity.Critical, IsRequired = true, ParentControlId = "EXT-11", EvidenceSources = new() { "Registry HKLM\\SYSTEM\\CurrentControlSet\\Control\\SecurityProviders\\SCHANNEL\\Protocols\\SSL 2.0\\Client" }, ExpectedValueType = ExpectedValueType.Integer, Operator = Operator.Equals },
                new SubControlDefinition { SubControlId = "CRP-001.6", SettingName = "SSL 3.0 Client Disabled", ExpectedValue = "0", Description = "Disables SSL 3.0 (prevents POODLE attack).", Category = CheckCategory.Network, Severity = CheckSeverity.Critical, IsRequired = true, ParentControlId = "EXT-11", EvidenceSources = new() { "Registry HKLM\\SYSTEM\\CurrentControlSet\\Control\\SecurityProviders\\SCHANNEL\\Protocols\\SSL 3.0\\Client" }, ExpectedValueType = ExpectedValueType.Integer, Operator = Operator.Equals },
